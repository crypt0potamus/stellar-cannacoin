  ...
  function () {
    ...
    return gulp.src(files)
      .pipe(
        wpPot(
          {
            domain: 'stellar-cannacoin',
            destFile: 'stellar-cannacoin.pot',
            package: 'stellar-cannacoin',
            lastTranslator: 'Stellar CannaCoin team<you@email.test>',
            team: 'Stellar CannaCoin team <you@email.test>'
          }
        )
      )
      .pipe(gulp.dest('languages/stellar-cannacoin.pot'))
  }
);
...
gulp.task('copy', function () {
  return gulp.src(srcs)
    .pipe(gulp.dest('/home/hector/svn-releases/stellar-cannacoin/trunk'))
})
